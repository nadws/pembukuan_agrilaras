                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            ...
                            <input type="checkbox" class="iktisar iktisar{{ $no + 1 }}" urutan="{{ $no + 1 }}" isi="H"
                                value="H" id="" {{ $a->profit_loss == 'H' || $a->profit_loss == 'Y' ||
                            !empty($a->id_akun) ? 'checked' : '' }}
                        ...
                        <td>
                            <input type="checkbox" id_akun="{{ $a->id_akun }}" class="form-check klikCek " value="T"
                                count="{{ $no + 1 }}">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td align="center">
                        <input type="hidden" name="id_akun[]" value="{{ $a->akun_id }}">
                        <input type="checkbox" class="iktisar iktisar{{ $no + 1 }}" urutan="{{ $no + 1 }}" isi="H"
                            value="H" id="" {{ $a->profit_loss == 'H' || $a->profit_loss == 'Y' || !empty($a->id_akun) ?
                        'checked' :
                        '' }}
                        {{ $a->profit_loss == 'Y' || !empty($a->id_akun) ? 'disabled' : '' }}>
