...
<div class="card-body">
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="semuaAkun-tab" data-bs-toggle="tab" href="#semuaAkun" role="tab" aria-controls="contact" aria-selected="false" tabindex="-1">Semua Akun</a>
        </li>
    </ul>
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane" id="semuaAkun" role="tabpanel" aria-labelledby="semuaAkun-tab">
