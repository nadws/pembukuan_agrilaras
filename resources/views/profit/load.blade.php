    ...
    $totalperalatan += ($a->h_perolehan - $a->beban) < 1 ? 0 : $a->biaya_depresiasi;
        ...
        open27: false,
                ...
                <tr>
                    ...
                    <td colspan="2" class="fw-bold" align="right">Rp {{number_format($estimasi_telur_bulan->estimasi -
                        $total_budget,0)}}</td>
                </tr>
                <tr>
                ...
                <tr x-show="open27">
                    ...
                    <td colspan="2" align="right">Rp {{$b->id_akun == 51 ? number_format($aktiva->biaya,0) :
                ...
                <tr>
                    ...
                    <td colspan="2" class="fw-bold" align="right">Rp {{number_format($aktiva->biaya +
                        $totalperalatan,0)}}</td>
                </tr>
                <tr>
                    ...
                    <td colspan="2" class="fw-bold" align="right">Rp {{number_format($estimasi_telur_bulan->estimasi -
                        $total_budget - $aktiva->biaya - $totalperalatan,0)}} </td>
                </tr>
                ...
                <tr>
                    ...
                    <th colspan="3" class="dhead" style="text-align: right">Rp {{number_format($totalBiaya +
                        $totalBiaya2 -
                        $totalbkn,0)}}
                    </th>
                </tr>
                ...
                <tr x-transition x-show="open22">
                    ...
                    <td colspan="2" style="text-align: right">Rp. {{ number_format($a->debit + + $a->debit_saldo, 1) }}
                    </td>
                </tr>
                @endforeach
                <tr x-transition x-show="open26">
