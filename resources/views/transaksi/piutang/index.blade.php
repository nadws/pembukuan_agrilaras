<x-theme.app title="Piutang" table="Y" sizeCard="12">
    <x-slot name="cardHeader">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
            ...
            <div class="d-flex gap-2">@if(in_array($jenis,['telur','ayam'],true))<button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="{{ $jenis === 'ayam' ? '#importPiutangAyamAccurate' : '#importPiutangAccurate' }}"><i class="fas fa-file-excel me-1"></i> Import Accurate</button>@endif<button type="button" class="btn btn-outline-success btn-sm" data-bs-toggle="modal" data-bs-target="#modalRiwayat"><i class="fas fa-history me-1"></i> Riwayat Pelunasan</button><a href="{{ route('transaksi') }}" class="btn btn-outline-primary btn-sm"><i class="fas fa-arrow-left me-1"></i> Transaksi</a></div>
        </div>
    </x-slot>
