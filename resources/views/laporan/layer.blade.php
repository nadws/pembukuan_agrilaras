            ...
            <div class="table-responsive table-container">
                ...
                <table style="text-align: center; ">
                    <thead style="border: 1px solid white">
                        <tr>
                            <th class="dhead freeze-cell1" rowspan="2">Kdg <br> chick in <br> Afkir <br> chick in2
                                <br>
                                {{ date('d/m/y') }}
                            </th>
                            <th class="dhead freeze-cell">Umur <br> 85 mgg</th>
                            <th class="dhead" width="5%" colspan="2">Populasi</th>
                        ...
                        <tr>
                            {{-- Umur --}}
                            <th class="dhead freeze-cell">mgg <br>
                            ...
                            {{-- Populasi --}}
                            <th class="dhead">pop <br>awal <br> akhir</th>
                            ...
                            <th class="dhead">hd <br> p <br> hh (%)<br>
                    ...
                    <tbody>
                        ...
                        @foreach ($kandang as $k)
                            ...
                            @endphp
                            <tr>
                                <td align="center" class="kandang freeze-cell1">{{ $k->nm_kandang }} <br>
                                ...
                                <!-- Umur -->
                                <td align="center"
                                    class="freeze-cell mgg {{ $k->mgg >= '85' ? 'text-danger fw-bold' : '' }}">
                            ...
                            --}}
                                ...
                                <td align="center" class="FCR(week) {{ $fcr >= 2.2 ? 'text-danger fw-bold' : '' }} ">
                                    @if ($k->mgg < 21)
                                        0 <br> 0 <br> 0
                                    @else
                                ...
                                <!-- pakan -->
                                <td style="text-align: center" class="kg w_pakan">
                    ...
                    <tfoot>
                        <tr>
                            <th class="dhead freeze-cell1" colspan="2">Total</th>
                            <th class="dhead">{{ number_format($ayam_awal, 0) }}
                                <br>{{ number_format($ayam_akhir, 0) }} <br>
                                {{ number_format(($ayam_akhir / $ayam_awal) * 100, 0) }} %
                            </th>
                            <th class="dhead text-end">{{ $mati }} <br> {{ $jual }} <br>
                                {{ $dc_week }}</th>
                            ...
                            <th class="dhead">{{ number_format($pakan_kuml, 2) }} <br>
