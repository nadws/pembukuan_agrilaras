<x-theme.app title="{{ $title }}" table="Y" sizeCard="11">
    ...
    <x-slot name="cardBody">
        ...
        <form action="{{ route('save_setoran_umum') }}" method="post">
            @csrf
    ...
    <script>
        $(document).ready(function() {
                ...
                $(document).on('click', '.btn_bayar', function() {
                    ...
                    window.location.href = "/penjualan_umum_perencanaan_setor?" + queryString;

                });
                $(document).on('click', '.list_perencanaan', function() {
                    $.ajax({
                        type: "get",
                        url: "/get_list_perencanaan_umum",
                ...
                $(document).on('click', '.perencanaan', function() {
                    ...
                    $.ajax({
                        type: "get",
                        url: "/get_perencanaan_umum?no_nota=" + no_nota,
                        success: function(data) {
                ...
                $(document).on('click', '.history_perencanaan', function() {
                    $.ajax({
                        type: "get",
                        url: "/penjualan_umum_get_history_perencanaan",
                        success: function(data) {
                ...
                $(document).on('submit', '#history_serach', function(e) {
                    ...
                    $.ajax({
                        type: "get",
                        url: "/penjualan_umum_get_history_perencanaan?tgl1=" + tgl1 + "&tgl2=" + tgl2,
                        success: function(data) {
                            $('#get_history').html(data);
                        }
                    });
