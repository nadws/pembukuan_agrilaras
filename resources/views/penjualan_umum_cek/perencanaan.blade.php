<x-theme.app title="{{ $title }}" table="Y" sizeCard="11">
    ...
    <x-slot name="cardBody">
        ...
        <form action="{{ route('penjualan_umum_save_perencanaan') }}" method="post" class="save_jurnal">
            @csrf
    ...
    <x-slot name="cardFooter">
        ...
        <a href="{{ route('penyetoran_penjualan_umum') }}" class="float-end btn btn-outline-primary me-2">Batal</a>
        </form>
    </x-slot>
