    ...
    <x-slot name="cardBody">
        <section class="row">
            <div class="col-md-12">
                @php
                $ttlAllPiutang = 0;
                foreach ($invoice_ayam as $i) {
                $ttlAllPiutang += $i->qty * $i->h_satuan;
                }
                @endphp
            ...
            <table class="table table-bordered" id="tablealdi" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <input type="checkbox" no_nota="{{ $i->no_nota }}" piutang="{{ $i->qty * $i->h_satuan }}"
        ...
        <script>
            $(document).ready(function() {
                ...
                $(document).on('click', '.btn_bayar', function() {
                    ...
                    window.location.href = "/bayar_piutang_ayam?" + queryString;
