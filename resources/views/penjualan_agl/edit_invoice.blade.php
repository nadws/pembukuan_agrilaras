        ...
        <form action="{{ route('edit_penjualan_telur') }}" method="post" class="save_jurnal">
            ...
            <section class="row">
                ...
                <div class="col-lg-2 col-6">
                    ...
                    <input type="text" readonly class="form-control" name="tipe" value="{{ $invoice2->tipe }}"
                        id="tipe">
                </div>
                <div class="col-lg-2 col-6">
                ...
                <div class="col-lg-7">
                        ...
                        @foreach ($jurnal as $no => $j)
                            ...
                            <div class="col-lg-3 mt-2">
                                ...
                                <input type="text" class="form-control debit debit1" count="1"
                                    style="text-align: right" value="Rp {{ number_format($j->debit, 0, ',', '.') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <h6 class="total_kredit float-end">Rp
                                {{ number_format($invoice2->total_rp + $j->kredit, 2, '.', ',') }}
                            </h6>
                        </div>
                        <div class="col-lg-5">
                        ...
                        <div class="col-lg-4">
                            <h6 class="selisih float-end cselisih ">Rp
                                {{ number_format($ttl_debit - ($invoice2->total_rp + $ttl_kredit), 2, '.', ',') }}
                            </h6>
                        </div>
                    </div>
