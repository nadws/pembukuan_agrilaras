    ...
    <tbody>
        ...
        <tr>
            ...
            <td align="center">
                ...
                <input type="checkbox" class="iktisar1 iktisarA{{ $no + 1 }} " urutan="{{ $no + 1 }}" isi="Y" value="Y"
                    id="" {{ $a->iktisar == 'Y' ? 'checked' : '' }}>
            </td>
            <td align="center">
                <input type="checkbox" class="iktisar2 iktisarB{{ $no + 1 }}" urutanB="{{ $no + 1 }}" isi="H" value="H"
                    id="" {{ $a->iktisar == 'H' ? 'checked' : '' }}>
