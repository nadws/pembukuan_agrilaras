...
class Forecast extends Model
{
    ...
    public static function detailEggProduction()
    {
        ...
        return  DB::select("SELECT a.nm_kandang , (a.stok_awal - b.pop_hilang) as populasi
        FROM kandang as a 
        left join (
            SELECT b.id_kandang, sum(b.mati + b.jual + b.afkir) as pop_hilang FROM populasi as b
