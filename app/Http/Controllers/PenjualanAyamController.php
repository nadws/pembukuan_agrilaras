...
class PenjualanAyamController extends Controller
{
    ...
    public function save_perencanaan(Request $r)
    {
        ...
        //     DB::table('jurnal')->insert($data);
        // }
        return redirect()->route('penjualan_ayam.penyetoran')->with('sukses', 'Data berhasil ditambahkan');
    }
    ...
    public function get_list_perencanaan()
    {
        ...
        return view('penjualan_ayam.list_perencanaan', $data);
    }
    ...
    {
        DB::table('setoran_ayam')->where('nota_setor', $r->no_nota)->update(['selesai' => 'Y']);
        ...
        return redirect()->route('penjualan_ayam.penyetoran')->with('sukses', 'Data berhasil disetor');
    }
}
