    ...
    private function martadahInvoiceRows(string $noNota): Collection
    {
        return DB::table('invoice_telur as a')
            ...
            ->get([
                ...
                DB::raw("CASE WHEN LOWER(a.tipe) = 'pcs' THEN a.pcs ELSE 0 END as pcs_pcs"),
                DB::raw("CASE WHEN LOWER(a.tipe) = 'pcs' THEN a.kg ELSE 0 END as kg_pcs"),
                DB::raw("CASE WHEN LOWER(a.tipe) = 'pcs' THEN a.rp_satuan ELSE 0 END as rp_pcs"),
                DB::raw('0 as ikat'),
                DB::raw('0 as kg_ikat'),
                DB::raw('0 as rp_ikat'),
                DB::raw("CASE WHEN LOWER(a.tipe) = 'kg' THEN a.pcs ELSE 0 END as pcs_kg"),
                DB::raw("CASE WHEN LOWER(a.tipe) = 'kg' THEN a.kg ELSE 0 END as kg_kg_kotor"),
                DB::raw("CASE WHEN LOWER(a.tipe) = 'kg' THEN a.kg_jual ELSE 0 END as kg_kg"),
                DB::raw('0 as rak_kg'),
                DB::raw("CASE WHEN LOWER(a.tipe) = 'kg' THEN a.rp_satuan ELSE 0 END as rp_kg"),
